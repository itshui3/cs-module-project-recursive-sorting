...
class RecursiveSortingTests(unittest.TestCase):
    ...
    def test_agnostic_binary_search(self):
        ...
        self.assertEqual(iter_agnostic_binary_search(ascending, 12), 2)
        self.assertEqual(iter_agnostic_binary_search(ascending, 54), 9)
        self.assertEqual(iter_agnostic_binary_search(ascending, 31), -1)

        self.assertEqual(iter_agnostic_binary_search(descending, 49), 3)
        self.assertEqual(iter_agnostic_binary_search(descending, -17), 7)
        self.assertEqual(iter_agnostic_binary_search(descending, -1), -1)
